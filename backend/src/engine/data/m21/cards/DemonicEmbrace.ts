import { AbilityType, ZoneRequirement, CardDefinition, EffectType, TargetType, TargetMapping } from '@shared/engine_types';
...
export const DemonicEmbrace: CardDefinition = {
    ...
    abilities: [
        ...
        },
        {
            ...
            effects: [{ type: EffectType.AllowCastFromGraveyard, additionalCosts: [{ type: 'PayLife', value: 3 }, { type: 'Discard', amount: 1 }], targetMapping: TargetMapping.Self }]
        }
    ]
