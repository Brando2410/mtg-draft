            ...
            additionalCosts: [
                {
                    ...
                    type: 'Choice',
                    choices: [
                        { label: 'Sacrifice a creature', costs: [{ type: CostType.Sacrifice, targetMapping: TargetMapping.Target1, targetDefinition: { count: 1, type: TargetType.Permanent, restrictions: [{ type: 'Type', value: 'Creature' }] } }] },
