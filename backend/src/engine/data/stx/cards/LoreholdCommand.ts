import { AbilityType, CardDefinition, EffectType, Restriction, TargetMapping, TargetType, DurationType } from '@shared/engine_types';
            ...
            choices: [
                ...
                { 
                    ...
                    effects: [{ 
                        ...
                        powerModifier: 1, 
                        abilitiesToAdd: ['Indestructible', 'Haste'], 
