...
export const VeilofSummer: CardDefinition = {
    name: "Veil of Summer",
    manaCost: "{G}",
    ...
    set: "soa",
    abilities: [],
    scryfall_id: "5724a4a3-dd66-4a66-af8b-5374119ecdfb",
    image_url: "https://cards.scryfall.io/normal/front/5/7/5724a4a3-dd66-4a66-af8b-5374119ecdfb.jpg?1775936806",
    rarity: "rare"
};
