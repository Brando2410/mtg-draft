...
export const Restriction = {
    ...
    Attacking: 'attacking',
    Blocking: 'blocking',
    WasDealtDamageThisTurn: 'wasdealtdamagethisturn',
    ...
    ArtifactOrCreature: 'artifactorcreature',
    WithoutFlying: 'withoutflying',
    White: 'white',
    Blue: 'blue',
    Black: 'black',
    Red: 'red',
    ...
    CreatureOrLand: 'creatureorland',
    CreatureOrPlaneswalker: 'creatureorplaneswalker',
    ArtifactOrEnchantment: 'artifactorenchantment',
    NonlandPermanent: 'nonlandpermanent',
    Forest: 'forest',
    Island: 'island',
    Mountain: 'mountain',
