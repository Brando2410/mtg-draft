        ...
        <form onSubmit={handleJoin} className="w-full space-y-4 lg:space-y-4 max-lg:landscape:space-y-3">
          ...
          <div className="pt-2 max-lg:landscape:pt-0 flex gap-3 max-lg:landscape:max-w-md">
            ...
            <button
              ...
              className={`flex-1 bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-800 disabled:text-slate-700 text-white rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] max-lg:landscape:text-[9px] flex items-center justify-center gap-3 transition-all active:scale-95 group whitespace-nowrap ${loading || code.length < 6 || !name.trim() ? 'shadow-none' : 'shadow-xl shadow-emerald-600/20'
                }`}
            >
