        ...
        {!minimized && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              className="bg-[#0b0f1a]/95 border border-white/10 p-[var(--sp-12)] rounded-[calc(var(--u)*8)] shadow-[0_40px_100px_rgba(0,0,0,0.9)] max-w-[95vw] w-full flex flex-col items-center gap-[var(--sp-8)] text-center relative backdrop-blur-2xl"
            >
              {/* MINIMIZE BUTTON */}
              <button
