        ...
        {!minimized && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-[#0b0f1a]/95 border border-white/10 p-[var(--sp-12)] px-[var(--sp-8)] rounded-[calc(var(--u)*8)] shadow-[0_40px_100px_rgba(0,0,0,0.9)] max-w-lg w-full flex flex-col items-center gap-[var(--sp-8)] text-center relative backdrop-blur-2xl"
            >
              {/* MINIMIZE BUTTON */}
              <button
                onClick={() => setMinimized(true)}
                className="absolute top-[var(--sp-4)] right-[var(--sp-4)] h-[calc(var(--u)*4.5)] px-[var(--sp-4)] bg-white/5 hover:bg-white/10 rounded-full text-slate-500 hover:text-white transition-all flex items-center gap-[var(--sp-2)] text-[var(--fs-xs)] font-black z-30 tracking-widest border border-white/10 backdrop-blur-md"
              >
                <EyeOff className="w-[var(--sp-4)] h-[var(--sp-4)]" />
                HIDE
              </button>

              <div className="w-20 h-20 bg-indigo-600 rounded-3xl flex items-center justify-center shadow-lg ring-4 ring-indigo-500/20 rotate-3 mt-4">
              ...
              <div className="flex flex-col items-center gap-6 w-full">
                ...
                <div className="flex items-center gap-2 w-full px-2">
                  <button
                    ...
                    className="flex-1 btn-premium-danger !w-auto"
                  >
                    Cancel
                  </button>
                  ...
                  <button
                    ...
                    className="flex-[2] btn-premium-primary !w-auto"
                  >
                    <span className="drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] uppercase tracking-widest text-[var(--fs-sm)] truncate px-1">Submit</span>
                  </button>
                </div>
              </div>
            </motion.div>
