               ...
               <div className="flex items-center gap-4 lg:w-1/3">
                  <div className="flex flex-col">
                     <h1 className="text-2xl lg:text-5xl font-black text-white uppercase italic tracking-tighter leading-none">
                        <span className={rules.isSealed ? "text-purple-500" : (isNormalMatch ? "text-indigo-500" : "text-emerald-500")}>
               ...
               <div className="flex items-center gap-3 justify-end lg:flex-1 shrink-0">
                  {!isNormalMatch && (
                     ...
                     >
                        ...
                        <span className="hidden sm:inline text-xs font-black uppercase tracking-widest">Rules</span>
                     </button>
                  )}
                  ...
                  {isHost ? (
                     <div className="flex items-center gap-3 shrink-0">
                        ...
                        >
                           {isNormalMatch ? 'Start Match' : (rules.isSealed ? 'Start Event' : 'Start Draft')} <Play className="w-4 h-4 fill-current" />
                        </button>
               ...
               <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                  ...
                  <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="relative w-full max-w-lg bg-slate-900 border border-white/10 rounded-[3rem] p-10 shadow-2xl">
                     <div className="flex justify-between items-center mb-8 shrink-0">
                        <h3 className="text-3xl font-black text-white uppercase italic tracking-tighter">Rules <span className={rules.isSealed ? "text-purple-500" : "text-indigo-500"}>{rules.isSealed ? 'Sealed' : 'Draft'}</span></h3>
